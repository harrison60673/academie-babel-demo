...
(function (global) {
  ...
  var ENTRIES = {
    ...
    '上課方式與時間': ['Class formats & hours', 'Formats et horaires', 'شیوهٔ کلاس و ساعات کاری'],
    ...
    '上課方式': ['Class formats', 'Formats des cours', 'شیوهٔ برگزاری کلاس'],
  ...
  var EXTRA_ENTRIES = {
    ...
    '每堂 90 分鐘': ['90 minutes per lesson', '90 minutes par cours', 'هر جلسه ۹۰ دقیقه'],
    '週一・三 20:00–21:30／Julien Marchand': ['Mon & Wed 20:00–21:30 / Julien Marchand', 'Lun. et mer. 20 h–21 h 30 / Julien Marchand', 'دوشنبه و چهارشنبه ۲۰:۰۰ تا ۲۱:۳۰ / Julien Marchand'],
    '週一・四 19:30–21:30／Sophie Lambert': ['Mon & Thu 19:30–21:30 / Sophie Lambert', 'Lun. et jeu. 19 h 30–21 h 30 / Sophie Lambert', 'دوشنبه و پنج‌شنبه ۱۹:۳۰ تا ۲۱:۳۰ / Sophie Lambert'],
    '週二・四 19:30–21:30／Camille Béranger': ['Tue & Thu 19:30–21:30 / Camille Béranger', 'Mar. et jeu. 19 h 30–21 h 30 / Camille Béranger', 'سه‌شنبه و پنج‌شنبه ۱۹:۳۰ تا ۲۱:۳۰ / Camille Béranger'],
    '週三 19:00–21:00／Julien Marchand': ['Wed 19:00–21:00 / Julien Marchand', 'Mer. 19 h–21 h / Julien Marchand', 'چهارشنبه ۱۹:۰۰ تا ۲۱:۰۰ / Julien Marchand'],
    '週六 14:00–17:00／Sophie Lambert': ['Sat 14:00–17:00 / Sophie Lambert', 'Sam. 14 h–17 h / Sophie Lambert', 'شنبه ۱۴:۰۰ تا ۱۷:۰۰ / Sophie Lambert'],
    '週六 10:00–13:00／Sophie Lambert': ['Sat 10:00–13:00 / Sophie Lambert', 'Sam. 10 h–13 h / Sophie Lambert', 'شنبه ۱۰:۰۰ تا ۱۳:۰۰ / Sophie Lambert'],
    '週日 10:00–12:30／Julien Marchand': ['Sun 10:00–12:30 / Julien Marchand', 'Dim. 10 h–12 h 30 / Julien Marchand', 'یکشنبه ۱۰:۰۰ تا ۱۲:۳۰ / Julien Marchand'],
    ...
    '里昂第二大學 FLE 碩士，具六年成人法語教學經驗。專門帶完全沒有基礎的成人班，把發音與 conjugaison 拆成小步驟，讓學生在第一堂課就能開口說完整的句子。相信初學階段最重要的不是正確，而是不怕。': ['With a master’s in FLE from Lyon 2 University and six years of experience teaching adults, she specializes in complete beginners, breaking pronunciation and conjugation into small steps so students speak complete sentences from lesson one. At the beginner stage, confidence matters more than perfection.', 'Titulaire d’un master FLE de Lyon 2 et forte de six ans d’expérience auprès d’adultes, elle accompagne les grands débutants en décomposant prononciation et conjugaison afin qu’ils produisent des phrases complètes dès le premier cours. Au début, l’essentiel n’est pas la perfection, mais l’absence de peur.', 'دارای کارشناسی ارشد FLE از دانشگاه لیون ۲ و شش سال تجربهٔ آموزش فرانسه به بزرگسالان است. متخصص زبان‌آموزان کاملاً مبتدی است و تلفظ و صرف را گام‌به‌گام آموزش می‌دهد تا زبان‌آموز از جلسهٔ اول جملهٔ کامل بگوید. در آغاز، نترسیدن مهم‌تر از بی‌نقص بودن است.'],
    ...
    'ACADÉMIE BABEL 法語學院的聯絡方式：Instagram 私訊、Email、上課方式、線上課程說明與營業時間。': ['Contact ACADÉMIE BABEL by Instagram or email, with class formats, online-course details and opening hours.', 'Contactez ACADÉMIE BABEL par Instagram ou e-mail ; formats de cours, modalités en ligne et horaires.', 'راه‌های تماس با آکادمی بابل از طریق اینستاگرام و ایمیل، همراه با شیوهٔ کلاس، توضیح آنلاین و ساعات کاری.'],
